...
<%
	List<BbsVO> bbsList =(List)request.getAttribute("searchResult") ;
		String yOn = String.valueOf(bbsList);
%>
<!DOCTYPE html>
<html>
<head>
		...
		%>
			<div class="container">
				...
				<table class="table table-striped">
					...
					<tr>
						<td><c:out value="<%=bbsList.get(i).getUserId() %>"></c:out></td>
						<td><a href="/booking/tour/bbsOne?oneKey=<%=bbsList.get(i).getBbsnum()%>"><c:out value="<%=bbsList.get(i).getTitle()%>" ></c:out></a></td>
						<td><c:out value="<%=bbsList.get(i).getArea()%>"></c:out></td>
						<td><c:out value="<%=bbsList.get(i).getBbstime()%>"></c:out></td>
					</tr>
					<%} %>
					<tr>
					</tr>
