    				...
    				<tbody>	
      				<tr>
						...
						<td>
      					...
      					<td><input type="text" name="title" class="form-control" style="width:1028px;" placeholder="글 제목" maxlength="40"></td>
						
      				</tr>
      				<tr>
      					<td colspan="3"><textarea type="text" class="form-control" placeholder="글 내용을 작성하세요" name="bbscont" maxlength="1024" style="height: 600px; "></textarea></td>
     				</tr>
    				</tbody>
  				</table>
